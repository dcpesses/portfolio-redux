  ...
  return (
    <div id="page-about" className="container page">
      <div id="bio" className="row justify-content-center">
        <div id="photo" className="col-sm-4 col-md-3 mb-3 text-center text-sm-end">
          <img src={profilePhoto} id="photo" className="img-fluid rounded-2 mx-auto" alt="App Screenshot" />
        </div>
